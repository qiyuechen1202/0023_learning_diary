...
This week, we further expanded the classifiers and discussed methods for assessing accuracy. The development of remote sensing classification algorithms is rapid, and object-based methods provide new approach for classification. In urban planning, OBIA can be used to obtain data such as building distribution and transportation network layout. The vector data can be further integrated with Geographic Information System (GIS) for spatial analysis and visualization, enhancing the understanding and utilisation of geographic information. Additionally, these vector data can be integrated with geographic datasets in GIS to further enrich GIS databases, supporting planners in management and decision-making.
